...
command_base = 'exec /usr/bin/python ../rl_server_bbb/'
...
url = 'http://' + ip + '/' + 'bbb_' + abr_algo + '.html'
...
try:
    ...
    if abr_algo == 'RL':
        command = command_base + 'rl_server_no_training.py ' + trace_file
    elif abr_algo == 'fastMPC':
        command = command_base + 'mpc_server.py ' + trace_file
    elif abr_algo == 'robustMPC':
        command = command_base + 'robust_mpc_server.py ' + trace_file
    else:
        command = command_base + 'simple_server.py ' + abr_algo + ' ' + trace_file
